...
import uk.gov.hmrc.emcstfereferencedata.connector.retrieveTraderKnownFacts.RetrieveTraderKnownFactsConnector
...
@Singleton
class RetrieveTraderKnownFactsService @Inject()(connector: RetrieveTraderKnownFactsConnector) {
  ...
  def retrieveTraderKnownFacts(exciseRegistrationId: String)(implicit hc: HeaderCarrier, ec: ExecutionContext): Future[Either[ErrorResponse, Option[TraderKnownFacts]]] =
    connector.retrieveTraderKnownFacts(exciseRegistrationId)
